...
QT_MOC_LITERAL(32, 529, 10), // "processImg"
QT_MOC_LITERAL(33, 540, 3), // "img"
QT_MOC_LITERAL(34, 544, 9), // "comLogAdd"
QT_MOC_LITERAL(35, 554, 3), // "txt"
QT_MOC_LITERAL(36, 558, 4) // "type"
    ...
    "capDoubleClickWin\0processImg\0img\0"
    "comLogAdd\0txt\0type"
};
...
void qtCyberDip::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        qtCyberDip *_t = static_cast<qtCyberDip *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 26: _t->processImg((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        case 27: _t->comLogAdd((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}

const QMetaObject qtCyberDip::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_qtCyberDip.data,
      qt_meta_data_qtCyberDip,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *qtCyberDip::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qtCyberDip.stringdata0))
        return static_cast<void*>(const_cast< qtCyberDip*>(this));
